...
scale_color_manual(values = c("red", 'black'))   #折线图等线图
scale_fill_manual(values = c("red", 'black'))  #柱状图等填充图
...
```{r}
# ==== 设置基因名称 ====
target_gene <- "PIN7"   # 这里改成 "PIN4" 就能复用整个脚本
...
#sample=c(0,1,2,3,19,20,30,40,10)
